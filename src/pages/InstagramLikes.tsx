...
const InstagramLikes = () => {
  ...
  const handleOrderClick = () => {
    if (selectedPackage) {
      ...
      if (pkg) {
        navigate(`/checkout?service=Instagram Likes&package=${pkg.likes}&price=${pkg.price}`);
      }
    }
  };

  const features = [
    { icon: <Check className="h-5 w-5 text-green-500" />, text: "100% Real Instagram Likes" },
  ...
  const benefits = [
    {
      ...
      description: "All likes come from genuine, active Instagram accounts that engage with content regularly."
    },
    {
    ...
    },
    {
      ...
      description: "More likes lead to increased visibility and help your posts reach the Explore page."
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Attract More Followers",
      description: "Posts with high like counts naturally attract more organic engagement and followers."
    },
    {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
      rating: 5,
      text: "Fast delivery and real likes! My photography is now reaching a much wider audience."
    },
    {
      name: "Zoe Chen",
      ...
      rating: 5,
      text: "The likes helped my travel photos gain traction. Now I'm getting brand collaboration offers!"
    }
  ];

  const faqs = [
    {
      question: "Are the Instagram likes real?",
      answer: "Yes, all our Instagram likes are 100% real and come from active Instagram accounts. We never use bots or fake profiles."
    },
    {
    ...
    },
    {
      ...
      answer: "No, we never ask for your password. We only need the link to your Instagram post to deliver the likes."
    },
    {
    ...
    {
      question: "Can I split likes across multiple posts?",
      answer: "Currently, each order is for a single post. If you want to boost multiple posts, please place separate orders for each."
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center min-h-[400px]">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">Loading Instagram Likes services...</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
                Instagram <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Likes</span>
              </h1>
      ...
      <div className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
              Buy Instagram <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Likes</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Boost your Instagram posts with real, high-quality likes. Increase engagement and reach more people.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {packages.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-gray-600 dark:text-gray-300 text-lg">No Instagram Likes packages available at the moment.</p>
